<template>
    <footer class="m-auto w-fit flex flex-col justify-center items-center pb-8 gap-2 mt-[10vh] md:mt-[5vh]">
        <div class="flex flex-row">
            <a class="font-sentient text-base no-underline" href="mailto:zhenghenry2@gmail.com">zhenghenry2@gmail.com</a>
        </div>
        ...
        <h3 class="font-sentient font-normal text-base">Created & Deployed by Henry Zheng</h3>
    </footer>
</template>
