<template>
    <div class="fixed w-12 left-12 right-auto bottom-0 z-10 flex-col items-center hidden md:flex">
        <div class="rotate-[-90deg] mb-[6.5rem]">
            <a class="font-poppins text-md no-underline transition ease-in-out hover:text-[#00a6ed]" href="mailto:zhenghenry2@gmail.com">zhenghenry2@gmail.com</a>
        </div>
    ...
    <div class="fixed w-12 right-12 left-auto top-0 z-10 flex-col items-center hidden md:flex">
        ...
        <div class="rotate-[-90deg] mt-[3.5rem]">
            <span class="font-poppins whitespace-nowrap text-md no-underline">Copyright © Henry Zheng.</span>
        </div>
    </div>
</template>