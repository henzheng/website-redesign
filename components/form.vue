<template>
    <div class="flex flex-col justify-center items-center w-[20rem] h-[90%]
                rounded shadow-2xl bg-white dark:bg-slate-800">
        <h3 class="font-poppins text-xl mt-10 mb-4">Send me a message!</h3>
        <form @submit.prevent="sendEmail" autocomplete="off" class="font-poppins flex flex-col text-sm gap-4 w-[80%]">
            <input 
